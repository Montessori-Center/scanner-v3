...
class WebhooksAnalyzer(BaseAnalyzer):
    ...
    def _detect_webhook_type(self, url: str) -> str:
        ...
        url_lower = url.lower()
        if 'slack' in url_lower: return 'slack'
        elif 'discord' in url_lower: return 'discord'
        elif 'telegram' in url_lower: return 'telegram'
        elif 'github' in url_lower: return 'github'
        else: return 'custom'
